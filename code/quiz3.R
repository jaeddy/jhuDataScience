...
# 2. The P-value is larger than 0.05. So, according to our criterion, we would fail to reject, which suggests that the interaction terms is necessary.
...
# 2. The estimated expected change in MPG per half ton increase in weight for for a specific number of cylinders (4, 6, 8).
# 3. The estimated expected change in MPG per one ton increase in weight.
# 4. The estimated expected change in MPG per half ton increase in weight for the average number of cylinders.
# 5. The estimated expected change in MPG per one ton increase in weight for a specific number of cylinders (4, 6, 8).
